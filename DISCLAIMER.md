...
- **Federal Bar Association Rules**: Members of the Federal Chamber of Advocates of Russia (Federalnaya Palata Advokatov Rossiyskoy Federatsii) must comply with attorney-client privilege rules (advokatskaya tayna) when using AI tools (see [PRIVACY.md](PRIVACY.md))
...
1. Checking the official source (pravo.gov.ru -- Official Internet Portal for Legal Information)
2. Verifying the provision is currently in force and has not been amended
3. Reading the full context of cited provisions
4. Consulting relevant court practice and explanatory notes (postanovleniya Plenuma)
...
This Tool aggregates data from official government sources:

| Source | Authority Level | Use Case |
|--------|----------------|----------|
| **pravo.gov.ru** | Official government source | Federal statute text (authoritative) |

**CRITICAL**: While pravo.gov.ru is an official government portal operated by the Administration of the President of the Russian Federation, the data in this Tool may be:

- Stale due to ingestion lag
- Incomplete due to parsing limitations
- Missing recent amendments
- Subject to OCR errors for older texts

### Commercial Legal Databases

For professional legal work, **always cross-check with commercial legal databases** such as:

- **ConsultantPlus** (editorially verified, with annotations and commentary)
- **Garant** (comprehensive legal information system)
- **Kodeks** (legal reference system)
- **pravo.gov.ru** (official government legal information system)
...
## Copyright Status of Russian Federal Legislation

Per **Article 1259, Paragraph 6 of the Civil Code of the Russian Federation** (Grazhdanskiy kodeks RF), the following are not subject to copyright:

- Official documents of state bodies and local self-government bodies
- Laws, court decisions, and other texts of legislative, administrative, and judicial nature
- Official translations of such documents

This means federal laws, codes, presidential decrees, and government resolutions are **not copyrightable** under Russian law. The legislative text in this database is therefore in the public domain.

## Currency and Staleness

### No Real-Time Updates

- Database updates are **periodic** and may lag official publications by **weeks or months**
- Russian law changes continuously through new statutes, amendments, and court decisions
...
1. **Regional Legislation** -- Only federal laws are covered; laws of subjects of the Russian Federation are not included
2. **Court Decisions** -- No court practice (sudebnaya praktika), Constitutional Court decisions, or Supreme Court explanatory notes
...
5. **Subordinate Legislation** -- Limited coverage of ministerial orders (prikazy) and agency regulations
...
- **Context Missing**: Without commentary and court practice, interpretation may be incorrect
- **Regional Law Blind Spots**: Cannot assess how federal law interacts with regional legislation
...
- **NO WARRANTY OF COMPLETENESS**: Searches may miss relevant provisions
...
2. **Official Verification**: Cross-check ALL results with official sources (pravo.gov.ru)
3. **Commercial Databases**: Use ConsultantPlus, Garant, or Kodeks for authoritative, annotated versions
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Russian-Law-MCP) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Russian-Law-MCP/issues
